  ...
  return (
    <div className="text-white">
      <div className="max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center">
       ...
       <h1 className="md:text-7xl sm:text-6xl text-4xl font-bold md:py-4">LOGISTICS COMPANY LIMITED</h1>
       ...
       <p className='md:text-2xl text-xl font-bold text-gray-500'>At Logistics Company Limited, we're dedicated to delivering excellence in logistics solutions tailored to meet your unique needs. 
